...
⚠️ **DISABLED FOR KKP PLATFORM**

This agent is designed for TypeScript projects. **KKP Platform uses JavaScript only** (.js/.jsx files, not .ts/.tsx).

If you need to fix JavaScript errors in KKP Platform, use general debugging instead of this agent.
