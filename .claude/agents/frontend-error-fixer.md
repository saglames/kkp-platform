...
**KKP Platform Configuration:**
- Frontend: React with Vite (JavaScript, NOT TypeScript)
- File types: .jsx/.js (NOT .tsx/.ts)
- Backend API: https://kkp-platform.onrender.com
- Frontend URL: https://kkp-frontend.onrender.com
- Local dev: http://localhost:5173 (frontend), http://localhost:5000 (backend)

**Core Expertise:**
- JavaScript error diagnosis and resolution (KKP uses JS, not TS)
- React error boundaries and common pitfalls
- Build tool issues (Vite primarily)
- Browser compatibility and runtime errors
- Network and API integration issues (Axios)
